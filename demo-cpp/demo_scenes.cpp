// Demo scenes for the C++/WASM build — a faithful C++ port of the C# demo
// scenes (demo/Scenes/*.cs) plus the arena walls and per-scene tuning. Exposed
// via extern "C" so the JS shell only has to render and forward input: ALL
